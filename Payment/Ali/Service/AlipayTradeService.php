<?php
namespace Payment\Ali\Service;
use \Exception;
use Payment\Ali\Aop\request\AlipayTradeWapPayRequest;
use Payment\Ali\Aop\request\AlipayTradePagePayRequest;
use Payment\Ali\Aop\request\AlipayTradeQueryRequest;
use Payment\Ali\Aop\request\AlipayTradeRefundRequest;
use Payment\Ali\Aop\request\AlipayTradeFastpayRefundQueryRequest;
use Payment\Ali\Aop\request\AlipayFundTransToaccountTransferRequest;
use Payment\Ali\Aop\request\AlipayTradePrecreateRequest;
use Payment\Ali\Aop\request\AlipayF2FPrecreateResult;
use Payment\Ali\Aop\AopClient;
/* *
...
class AlipayTradeService {
    ...
    public function qrPay($req)
    {
        ...
        // 首先调用支付api
        $response = $this->aopclientRequestExecute2($request, NULL, $req->getAppAuthToken());
